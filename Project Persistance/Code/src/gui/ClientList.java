...
public class ClientList extends JFrame {
	...
	public ClientList() {
		...
		String [] header={"CPR Number","Name","Address","Zip Code","City","Phone Number"};
	...
	public static void printAllCustomers() {
		...
		CustomerCtr myCustomer = new CustomerCtr();
		try {
			ArrayList<Customer> cus = myCustomer.getAll();
			for (Customer customer : cus) {
	          model.addRow(new Object[]{customer.getCpr(), customer.getName(), customer.getAddress(), customer.getZipCode(), customer.getCity(), customer.getPhoneNo()});
			}
		} catch (Exception e1) {
