...
public class mainMenu extends JFrame {
	...
	public mainMenu() {
		...
		btnCustomers.setFont(new Font("Adobe Gothic Std B", Font.BOLD, 25));
		...
		btnProducts.setFont(new Font("Adobe Gothic Std B", Font.BOLD, 25));
		...
		btnSales.setFont(new Font("Adobe Gothic Std B", Font.BOLD, 25));
